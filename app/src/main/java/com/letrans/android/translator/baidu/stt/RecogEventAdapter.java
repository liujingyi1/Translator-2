...
import com.letrans.android.translator.baidu.control.ErrorTranslation;
...
public class RecogEventAdapter implements EventListener {
    ...
    private static final String TAG = "RTranslator/RecogEventAdapter";
    ...
    public void onEvent(String name, String params, byte[] data, int offset, int length) {
        ...
        if (name.equals(SpeechConstant.CALLBACK_EVENT_ASR_LOADED)) {
            ...
            if (data.length != length) {
                Logger.e(TAG, "internal error: asr.audio callback data length is not equal to " +
                        "length param");
            }
